...
public class GetSymbolDetailBean {
    ...
    public static class DataBean {
        ...
        private String symbolFeeRate;
        private String balance;
        private String symbolFeeMax;
        private String symbolFeeMin;
        ...
        public String getSymbolFeeRate() {
            return symbolFeeRate;
        }

        public void setSymbolFeeRate(String symbolFeeRate) {
        ...
        public String getSymbolFeeMax() {
            return symbolFeeMax;
        }

        public void setSymbolFeeMax(String symbolFeeMax) {
            this.symbolFeeMax = symbolFeeMax;
        }

        public String getSymbolFeeMin() {
            return symbolFeeMin;
        }

        public void setSymbolFeeMin(String symbolFeeMin) {
